...
class Sale(Base):
    ...
    package_id: Mapped[int | None] = mapped_column(ForeignKey("print_packages.id", ondelete="SET NULL"), nullable=True, index=True)
    ...
    package = relationship("PrintPackage", back_populates="sales")
